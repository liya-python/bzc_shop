            ...
            <div class="user-data">
                ...
                <div class="my-order-item">
                    <div class="user-data-header">
                        <span class="order-time">2020-07-20 14:35:49</span>
                        <span class="order-num">订单号：
                        <span class="my-older-number">20200720102342342306</span>
                    </span>
                    </div>
                    <ul class="nav user-data-list">
                        ...
                        <li class="course-price">299.00</li>
                        <li class="real-price">188.00</li>
...
<style scoped>
    .main .banner {
        width: 100%;
        height: 324px;
        background: url(../../static/image/1111.jpg) no-repeat;
