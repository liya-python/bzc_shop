        ...
        <div class="cart-info">
            ...
            <div class="cart-item" v-for="course in course_list">
                <el-row>
                    ...
                    <el-col :span="4" class="course-price">¥{{course.real_price}}<br>
                        原价：{{course.price}}
                    </el-col>
                </el-row>
            </div>
    ...
    export default {
        ...
        methods:{
            ...
            payOrder(){
                ...
                this.$axios.post("http://127.0.0.1:9000/order/order/", {
                    ...
                    // 在订单成功后，向支付宝发起生成支付链接的请求
                    this.$axios.get("http://127.0.0.1:9000/payment/pay/",{
                        params:{
            ...
            get_course_select() {
                let token = this.check_user_login();
                this.$axios.get("http://127.0.0.1:9000/cart/order/", {
                    headers: {
                        // 提交token必须在请求头声明token  jwt必须有空格
                        "Authorization": "jwt " + token,
                    }
