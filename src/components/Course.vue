        ...
        <div class="main">
            ...
            <div class="condition">
                <ul class="cate-list">
                    ...
                    <li v-for="(cate,index) in cate_list" @click="category=cate.id" :class="category==cate.id?'this':''">
                        {{cate.name}}
                    </li>
                </ul>
                ...
                <div class="ordering">
                    <ul>
                        ...
                        <li class="default" @click="change_order_type('id')" :class="change_order_class('id')">默认
                        </li>
            ...
            <div class="course-list">
                ...
                <div class="course-item" v-for="course in course_list" @click="click_detail(course.id)">
                    <div class="course-image">
                        <img :src="course.course_img" alt="">
                    </div>
                    <div class="course-info">
                        <h3>{{course.name}} <span><img src="/static/image/" alt="">{{course.students}}人已加入学习</span>
                        </h3>
                        ...
                        <ul class="lesson-list">
                            <li v-for="(lesson, key) in course.lesson_list"><span class="lesson-title">{{key+1}} | 第{{key+1}}节：{{lesson.name}}</span>
...
<!--                            <span class="discount-type">{{course.discount_name}}</span>-->
                            <span class="discount-price">现价:{{course.price}}元</span>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            // 获取所有课程分类的信息
            get_all_category(){
                this.$axios.get('http://127.0.0.1:9000/course/category/',).then(response =>{
            ...
            get_all_course() {
                ...
                this.$axios.get( "http://127.0.0.1:9000/course/filter_course/", {
                    params: filters
                }).then(response => {
